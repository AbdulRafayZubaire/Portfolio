  ...
  return (
    <div className="fixed w-full h-[80px] px-4 bg-dark flex justify-center items-center border-b-[1px] border-lightGrey">
      ...
      <div className="hidden lg:flex fixed flex-column left-0 top-[35%] justify-center items-center rounded-[10px]">
        <ul>
          <li className="w-[160px] h-[60px] flex justify-center items-center ml-[-100px] hover:ml-[0px] duration-300 bg-[#0072b1] rounded-tr-[10px]">
            <a
          ...
          <li className="w-[160px] h-[60px] flex justify-center items-center ml-[-100px] hover:ml-[0px] duration-300 bg-[#171515]">
            <a
              className="flex justify-between items-center w-full text-white"
          ...
          <li className="w-[160px] h-[60px] flex justify-center items-center ml-[-100px] hover:ml-[0px] duration-300 bg-[#E1306C]">
            <a
              className="flex justify-between items-center w-full text-white"
          ...
          <li className="w-[160px] h-[60px] flex justify-center items-center ml-[-100px] hover:ml-[0px] duration-300 bg-[#00acee]">
            <a
              className="flex justify-between items-center w-full text-white"
          ...
          <li className="w-[160px] h-[60px] flex justify-center items-center ml-[-100px] hover:ml-[0px] duration-300 bg-[#DB4437] rounded-br-[10px]">
            <a
              className="flex justify-between items-center w-full text-white"
              href="/"
            >
